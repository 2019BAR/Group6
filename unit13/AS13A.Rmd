...
&emsp; &emsp;&emsp;&emsp;<font color=#5D8DE2>OfficeVisits：1.0856倍，Narcotics：1.0793倍</font><br>
</p class="qiz">
```{r}
...
&emsp; &emsp;&emsp;&emsp;<font color=#5D8DE2>OfficeVisits：1.0753倍，Narcotics：1.0698倍</font><br>
</p class="qiz">
```{r}
...
<p class="qiz">
&emsp; &emsp; ■ 兩個自變數的機率效果分別是？<br>
&emsp; &emsp;&emsp;&emsp;<font color=#5D8DE2>OfficeVisits：1.0593倍，Narcotics：1.0551倍</font><br>
</p class="qiz">
```{r}
