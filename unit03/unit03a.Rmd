...
<span style="font-size:24px">`r "\U1F4CB"`</span>: <br>
row列：Sodium，column行：Fat<br>
低鹽低脂的食物數量：3529<br>
低鹽高脂的食物數量：1355<br>
高鹽低脂的食物數量：1378<br>
高鹽高脂的食物數量：712
...
<span style="font-size:24px">`r "\U1F4CB"`</span>: <br>
0：低Carbs食物的最高VitaminC含量<br>
1：高Carbs食物的最高VitaminC含量
```{r}
...
<span style="font-size:24px">`r "\U1F4CB"`</span>: <br>
0：低Carbs食物的VitaminC 統計表 (min, 1st quartile, median, mean, 3rd quartile, max, NA)<br>
1：高Carbs食物的VitaminC 統計表 (min, 1st quartile, median, mean, 3rd quartile, max, NA)
```{r}
