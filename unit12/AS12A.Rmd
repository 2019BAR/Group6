...
<span style="font-size:24px"> `r "\U1F3AF"` : </span>
What if `x1=2, x2=3`?
...
&emsp; &emsp;<font color=VioletRed>0.1~0.9的等機率線</font><br>
<span style="font-size:24px"> `r "\U1F3AF"` : </span>
Given any point in the figure above, how can you tell its (predicted) probability approximately?<br>
&emsp; &emsp;<font color=VioletRed>看觀察點最接近的等機率線為何</font><br>
</p class="qiz">
<br><hr>
...
&emsp; &emsp;<font color=VioletRed>The logit is a transformation. Logistic regression is a regression model.<br>
&emsp; &emsp;The logit transformation transforms a line to a logistic curve. <br>
&emsp; &emsp;Logistic regression fits a logistic curve to set of data where the dependent variable can only take the values 0 and 1. <br>
&emsp; &emsp;It can be generalised to fitting ordinal data.</font><br>
</p class="qiz">
<br><br><br><hr>
